...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/categorie/newCat' => [[['_route' => 'new_category', '_controller' => 'App\\Controller\\TestController::newCategory'], null, null, null, false, false, null]],
        ...
        '/art_cat' => [[['_route' => 'article_par_cat', '_controller' => 'App\\Controller\\TestController::articlesParCategorie'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/art_prix' => [[['_route' => 'article_par_prix', '_controller' => 'App\\Controller\\TestController::articlesParPrix'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/article/(?'
